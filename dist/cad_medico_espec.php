                              ...
                              <form action=""  method="POST" name="actionJava">
                                ...
                                <div class="form-group">
                                    <div class="col">
                                      ...
                                      <input type="text" name="especialidade_cod_especialidade" id="especialidade_cod_especialidade" class="form-control" autocomplete="off" 
                                     value="<?php  echo $item ['cod_medico']; ?>" >
                                    <input type="text" name="medico_cod_medico" id="medico_cod_medico" class="form-control" autocomplete="off" 
                                   value="<?php  echo $item ['cod_medico']; ?>" >
                                    ...
                                    <div class="form-group">
                                        <div class="col">
                                           ...
                                           <span class="campo-obrigatorio"></span>
                                              ...
                                              <select class="form-control" name="nome_especialidade">
                                                <option>Selecionar</option>
                                                <?php 
                                                foreach ($lista as $item):
                                                ?>
                                                <option value="<?php echo $item['nome_especialidade'] ?>">
