...
<body class="sb-nav-fixed">
  ...
  <div id="pagina">            
    ...
    <li><a data-toggle="tab" href="#dados-profissionais">Dados Profissionais</a></li>
    </ul>
  ...
  <!-- Fim da pane-->    
      ...
      <div id="dados-profissionais" class="tab-pane fade">
            <br />

              <h3  align="center">Dados Profissionais</h3>
              ...
              <div class="row">
                             ...
                             <!--Início da coluna-->         
                               <div class="col-md-3 ">
                                            ...
                                            <div class="form-group">
                                                <div class="col">
                                                    <label > Especialização do Médico</label>
                                                   <span class="campo-obrigatorio"></span>
                                                       <?php                                                                 
