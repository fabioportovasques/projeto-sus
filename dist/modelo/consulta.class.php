			...
			public function pesquisar ( ) {
							...
							// preg_replace('/[^0-9]/', '', $pesquisar);
 							...
 							if (empty($_POST['cartao_sus'])) {
 								//Se for vázio
 								$cpf_user = $_POST['cartao_sus'];
 								

 								print '<div class="alert alert-danger" role="alert">
									  Favor preencher o campo o Número do cartão SUS!
									</div>';
								print '<script>window.setTimeout(function(){window.location=\'cad-consulta.php\';}, 2000);</script>';
								...
								from 
 								...
 								WHERE 
 								 	cartao_sus like  '".$_POST['cartao_sus']."' ";
							...
							if ($sql->rowCount() > 0) {
								...
								print '<script>window.setTimeout(function(){window.location=\'cad-consulta.php\';}, 4000);</script>';
