...
--
-- Host: localhost:3306
-- Tempo de geração: 05/06/2021 às 10:24
...
INSERT INTO `agenda_ubs` (`cod_agenda`, `data_agendamento`, `hora_agendamento`, `num_fichas`, `status_agenda`, `especialidade_cod_especialidade`, `ubs_cod_ubs`, `medico_cod_medico`, `usuario_cod_user`) VALUES
(1, '2021-05-26 00:00:00', '15:00', 10, 'A', 1, 1, 15, 55),
(2, '2021-06-05 00:00:00', '16:00', 15, 'A', 1, 1, 17, 56);
...
(54, 'Luiz Pedro', ' Henrique Castro', '1995-03-18', '16694368887', '320174839', 'QNP 16 Conjunto Q', 'Ceilândia Sul (Ceilândia)', 'Brasília', '16694368887', 'DF', 'Brasil', 'luiz@gmail.com', '6125564499', '61993527922', '12', NULL, 'masculino', '6e63aa9f23a7ff9ff9b1f4f3a0a3f1e9', 'Paciente', 1, 'a'),
(55, 'Rosa Kamilly ', 'da Cunha', '1983-12-18', '46590640343', '476437829', 'Rua José Monek', 'Loteamento Vista Alegre', 'Campo Largo', '46590640343', 'PR', 'Brasil', 'rosa@gmail.com', '789789', '879879', '13', NULL, 'femenino', '6e63aa9f23a7ff9ff9b1f4f3a0a3f1e9', 'Medico', 1, 'a'),
(56, 'Danilo Raimundo ', 'Leandro da Cunha', '1975-02-02', '00013926039', '118582677', 'Rua Aksakoff de Vilhena', 'São Jorge', 'Bagé', '00013926039', 'RS', 'Brasil', 'danilocunha@gmail.com', '7897897', '878979', '14', NULL, 'masculiino', '6e63aa9f23a7ff9ff9b1f4f3a0a3f1e9', 'Medico', 1, 'a'),
(57, 'Vera Eliane ', 'Milena Castro', '2021-06-12', '28056160060', '888', 'Rua Waldemar Milani', 'Habitar Brasil', 'Bagé', '28056160060', 'RS', 'Brasil', 'veramilena@yahoo.com.br', '889797', '87879', '888', NULL, 'femenino', '6e63aa9f23a7ff9ff9b1f4f3a0a3f1e9', 'Medico', 1, 'a');
...
ALTER TABLE `agenda_ubs`
  ADD PRIMARY KEY (`cod_agenda`,`especialidade_cod_especialidade`,`ubs_cod_ubs`,`medico_cod_medico`,`usuario_cod_user`),
  ...
  ADD KEY `fk_agenda_ubs_usuario1_idx` (`usuario_cod_user`);
...
--
ALTER TABLE `agenda_ubs`
  MODIFY `cod_agenda` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `especialidade`
  MODIFY `cod_especialidade` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `medico`
  MODIFY `cod_medico` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de tabela `paciente`
--
ALTER TABLE `paciente`
  MODIFY `cod_pac` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `usuario`
  MODIFY `cod_user` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
...
ALTER TABLE `agenda_ubs`
  ...
  ADD CONSTRAINT `fk_agenda_ubs_usuario1` FOREIGN KEY (`usuario_cod_user`) REFERENCES `usuario` (`cod_user`);
