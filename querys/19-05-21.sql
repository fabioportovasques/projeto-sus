...
*/
SELECT 
nome_especialidade, u.nome_ubs,u.bairro_ubs,
a.data_agendamento,a.hora_agendamento,a.num_fichas,m.nome_medico
 from 
agenda_ubs a 
inner join ubs u on a.cod_agenda = u.cod_ubs
inner join especialidade e on e.cod_especialidade = u.cod_ubs
